...
- Remote Mastodon instances from which you are following people won't PuSH new private (followers-only) messages to your instance. This is a known bug, see [#2672](https://github.com/tootsuite/mastodon/issues/2672)
